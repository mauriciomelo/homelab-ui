...
- [x] **ui: capture minimal deployable inputs**: The Application Form captures the minimum data needed to deploy (name, image, ports, and health check inputs) with sensible defaults.
