...
describe('ResourceField', () => {
  ...
  describe('type="memory"', () => {
    test('renders input and unit', async () => {
      ...
      // default value and unit are shown
      await expect.element(input).toHaveValue('2');
      expect(page.getByText('Gi')).toBeDefined();
    });
    ...
    test('focus opens quick adjust popover', async () => {
      ...
      expect(page.getByText('Quick adjust')).toBeDefined();
      await expect.element(input).toHaveValue('2');
      await expect(page.getByRole('combobox').last()).toHaveTextContent('Mi');
    });
  ...
  describe('type="cpu"', () => {
    test('renders input and unit', async () => {
      ...
      expect(page.getByText('m')).toBeDefined();
    });
...
function StatefulResourceField(props: React.ComponentProps<typeof ResourceField>) {
